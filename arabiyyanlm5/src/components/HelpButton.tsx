      ...
      {open && (
        ...
        >
          <div
            ...
            className="w-full max-w-xl max-h-[85vh] overflow-y-auto rounded-2xl border p-8"
...
It is said that it takes 10,000 hours to master a skill. Don&rsquo;t worry! The FSI says it takes 2,200 hours to get fluent in Arabic. 
            ...
            <Section title="Study Steps">
              <div className="space-y-3">
                <p>1. Click the green book Icon in the centre of the page or the study tab</p>
                <p>2. Click Overview: Here you see the short passage in English first, then Arabic+ English then Arabic. There are instructions on each page on what to do.</p>
                <p>3. Click on Sentence 1. You will be taken to phase 1 which is the Arabic text broken down word by word with its audio and translation. This is the most important phase for beginners. You need to do lots and lots of listening. This helps you subconsciously acquire grammar.</p>
                <p>4. Each phase has a set of Instructions. Make sure to follow them. You can always do more reps if you need to. More not less.</p>
                <p>6. After going through the learning phases for a sentence, you can either go to the next sentences or come back tomorrow</p>
                <p>7. After you complete the learning phases for a sentence , It will appear in the review section. Try and say the full sentence in Arabic without checking. Grade your answers accordingly, it will be scheduled according to your answer and will show up for review at an optimal time.</p>
                <p>8. In case you are not a beginner don&rsquo;t worry you can use the overview section only if you feel you do not need, the breakdown. More features are coming Insha Allah with separate routines for beginners and intermediate learners.</p>
                <p>9. The listen section is there for you to listen to your lesson or sentences. You can set the sentence of passage to loop as much as you want.</p>
                <p>10. A good study routine will be to go through the learning phases in the morning, then come back in the evening,Go through the review tab to see how much you recall, then listen to the passage a few times on loop. You could set it to loop while you do chores or wind  down for the evening.</p>
              </div>
              <p>
